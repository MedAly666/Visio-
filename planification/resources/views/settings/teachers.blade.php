...
@section('settings')
    <div class="container flex justify-center items-center flex-col w-full mt-20">
        <div>
            <p class="text-7xl font-weight-bold text-gray-800" style="font-weight: 700">All Teachers </p>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('teachers.delete', ['id' => $teacher->id]) }}"
                                        class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-1.5 focus:outline-none ml-2">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="h-44 border-2 rounded-2xl flex justify-center items-center mb-20">
            ...
            <button data-modal-target="teacher-modal" data-modal-toggle="teacher-modal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none m-96" type="button">
                Add a teacher
            </button>

            <!-- Flowbite Modal -->
            <div id="teacher-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="teacher-modal">
                    ...
                    <form id="create-teacher" action="{{route('teachers.create')}}" method="POST" enctype="multipart/form-data" class="space-y-4">
                        @csrf
                        
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Teacher name</label>
                            <input type="text" name="teacher_name" id="name" placeholder="Enter teacher name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        </div>
                        <div>
                            <label for="grade" class="block mb-2 text-sm font-medium text-gray-900">Teacher grade</label>
                        ...
                        <div>
                            <label for="type" class="block mb-2 text-sm font-medium text-gray-900">Teacher type</label>
                        ...
                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
                            <button type="submit" form="create-teacher" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create</button>
                            <button data-modal-hide="teacher-modal" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">Close</button>
                        </div>
                    </div>
                </div>
            </div>
